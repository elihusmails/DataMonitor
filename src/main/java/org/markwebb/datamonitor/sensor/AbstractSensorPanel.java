...
public abstract class AbstractSensorPanel extends JPanel implements ActionListener
{
  ...
  public void setStateStopped(){ this.state = STOPPED; }
  public void setStatePaused(){ this.state = PAUSED; }
  public void setStateStarted(){ this.state = RUNNING; }
